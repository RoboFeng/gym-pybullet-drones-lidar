...
The simulation is run by a `BaseLaserAviary` environment.
...
from gym_pybullet_drones.envs.BaseLaserAviary import BaseLaserAviary
...
def run(
    ...
    env = BaseLaserAviary(drone_model=drone,
    ...
    for i in range(0, int(duration_sec*env.CTRL_FREQ)):
        ...
        for j in range(num_drones):
            action[j, :] = np.hstack([TARGET_POS[wp_counters[j], 0:2], INIT_XYZS[j, 2]])
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Helix flight script using BaseLaserAviary and DSLPIDControl')
    parser.add_argument('--drone',              default=DEFAULT_DRONES,     type=DroneModel,    help='Drone model (default: CF2X)', metavar='', choices=DroneModel)
    parser.add_argument('--num_drones',         default=DEFAULT_NUM_DRONES,          type=int,           help='Number of drones (default: 3)', metavar='')
    parser.add_argument('--physics',            default=DEFAULT_PHYSICS,      type=Physics,       help='Physics updates (default: PYB)', metavar='', choices=Physics)
    parser.add_argument('--gui',                default=DEFAULT_GUI,       type=str2bool,      help='Whether to use PyBullet GUI (default: True)', metavar='')
    parser.add_argument('--laser_record',       default=DEFAULT_RECORD_LASER,      type=str2bool,      help='Whether to record a point cloud (default: False)', metavar='')
