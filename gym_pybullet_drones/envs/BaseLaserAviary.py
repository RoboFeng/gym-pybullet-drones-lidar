...
class BaseLaserAviary(BaseAviary):
    """Multi-drone environment class for control applications using laser."""
    ...
    def __init__(self,
                 ...
                 obstacles=False,
                 user_debug_gui=True,
                 obs: ObservationType=ObservationType.LASER,
                 act: ActionType=ActionType.PID,
                 output_folder='results'
                 ):
        """Initialization of an aviary environment for control applications using laser.

        Attribute `laser_attributes` is automatically set to True when calling
        ...
        obs : ObservationType, optional
            The type of observation space (kinematic information or laser)
    ...
    def _actionSpace(self):
        ...
        if self.ACT_TYPE in [ActionType.RPM, ActionType.VEL]:
            ...
            print("[ERROR] in BaseLaserAviary._actionSpace()")
            exit()
    ...
    def _preprocessAction(self,
        ...
        for k in range(action.shape[0]):
            ...
            if self.ACT_TYPE == ActionType.RPM:
                ...
                print("[ERROR] in BaseLaserAviary._preprocessAction()")
                exit()
        return rpm
    ...
    def _observationSpace(self):
        ...
        """
        if self.OBS_TYPE == ObservationType.LASER:
            return spaces.Box(low=self.LASER_MASK,
                              high=self.LASER_RANGE,
                              shape=(self.NUM_DRONES, self.numRays, 3), dtype=np.float32)
            ...
            print("[ERROR] in BaseLaserAviary._observationSpace()")
    ...
    def _computeObs(self):
        ...
        if self.OBS_TYPE == ObservationType.LASER:
            ...
            print("[ERROR] in BaseLaserAviary._computeObs()")
